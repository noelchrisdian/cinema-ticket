...
export const CustomerSignin = () => {
    ...
    const submit = async (value: LoginValues) => {
        try {
	...
	return (
		<div
			...
			className="relative flex flex-col w-full max-w-[640px] min-h-screen mx-auto bg-black bg-[linear-gradient(179.86deg,_#000000_40.82%,_#0E0E24_99.88%)] text-white">
